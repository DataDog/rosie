...
public interface TypeScriptParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link TypeScriptParser#htmlTagStartName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlTagStartName(TypeScriptParser.HtmlTagStartNameContext ctx);
	/**
	 * Visit a parse tree produced by {@link TypeScriptParser#htmlTagClosingName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlTagClosingName(TypeScriptParser.HtmlTagClosingNameContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitHtmlChardata(TypeScriptParser.HtmlChardataContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link TypeScriptParser#objectExpressionSequence}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjectExpressionSequence(TypeScriptParser.ObjectExpressionSequenceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitHtmlElementExpression(TypeScriptParser.HtmlElementExpressionContext ctx);
	/**

...
public class ExpressionListTransformation {

    private static final Logger LOGGER = Logger.getLogger(ExpressionListTransformation.class.getName());

    public static Optional<PythonList> transformExpressionList(Node node, TreeSitterParsingContext parsingContext) {
        if (node == null || getNodeType(node) != TreeSitterPythonTypes.EXPRESSION_LIST) {

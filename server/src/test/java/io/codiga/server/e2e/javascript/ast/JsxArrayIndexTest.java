...
public class JsxArrayIndexTest extends E2EBase {
    ...
    public void testArrayKeyError() throws Exception {
        Response response = executeTest("bla.js", codeWithError, Language.JAVASCRIPT, ruleCode, "index-as-key", RULE_TYPE_AST, ENTITY_CHECKED_HTML_ELEMENT, null, true);
    ...
    public void testArrayKeyNoError() throws Exception {
        Response response = executeTest("bla.js", codeWithNoError, Language.JAVASCRIPT, ruleCode, "index-as-key", RULE_TYPE_AST, ENTITY_CHECKED_HTML_ELEMENT, null, true);
        logger.info(response.toString());
        assertEquals(1, response.ruleResponses.size());
    ...
    public void testArrayKeyNoError2() throws Exception {
        Response response = executeTest("bla.js", codeWithNoError2, Language.JAVASCRIPT, ruleCode, "index-as-key", RULE_TYPE_AST, ENTITY_CHECKED_HTML_ELEMENT, null, true);
        logger.info(response.toString());
        assertEquals(1, response.ruleResponses.size());
        assertEquals(0, response.ruleResponses.get(0).violations.size());
    }

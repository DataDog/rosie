...
public class TryBlockTest extends E2EBase {
    ...
    public void testFunctionCallRule() throws Exception {
        Response response = executeTestWithTreeSitter("bla.js", code, Language.JAVASCRIPT, ruleCode, "replace-foo-bar", RuleType.AST_CHECK, EntityChecked.TRY_BLOCK, null, true);

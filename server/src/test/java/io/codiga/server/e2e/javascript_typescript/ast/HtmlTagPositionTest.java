...
public class HtmlTagPositionTest extends E2EBase {
    ...
    public void testHtmlTagPosition() throws Exception {
        JAVASCRIPT_TYPESCRIPT.forEach(l -> {
            ...
            Response response = executeTest("bla.js", code1WithError, l, ruleCode, "htmltagposition", RULE_TYPE_AST, ENTITY_CHECKED_HTML_ELEMENT, null, true);
            ...
            response = executeTest("bla.js", code2WithError, l, ruleCode, "htmltagposition", RULE_TYPE_AST, ENTITY_CHECKED_HTML_ELEMENT, null, true);

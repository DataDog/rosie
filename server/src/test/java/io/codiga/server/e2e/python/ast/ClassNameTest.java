...
public class ClassNameTest extends E2EBase {
    ...
    public void testPythonClassNameError() throws Exception {
        Response response = executeTest("bla.py", pythonCodeWithError, Language.PYTHON, ruleCode, "class-name", RULE_TYPE_AST, ENTITY_CHECKED_CLASS_DEFINITION, false);
    ...
    public void testPythonClassNameNoError() throws Exception {
        Response response = executeTest("bla.py", pythonCodeWithNoError, Language.PYTHON, ruleCode, "class-name", RULE_TYPE_AST, ENTITY_CHECKED_CLASS_DEFINITION, false);

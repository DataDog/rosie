...
public class InsecureHashFunctionsTest extends E2EBase {
    ...
    public void testInsecureProtocol() throws Exception {
        Response response = executeTestWithTreeSitter("bla.py", pythonCodeWithError, Language.PYTHON, ruleCode, "insecure-hashing-protocol", RuleType.AST_CHECK, EntityChecked.FUNCTION_CALL, null, true);

...
public class InsecureSecurityProtocolsTest extends E2EBase {
    ...
    public void testInsecureProtocol() throws Exception {
        Response response = executeTest("bla.py", pythonCodeWithError, Language.PYTHON, ruleCode, "insecure-protocol-wrap-socket", RULE_TYPE_AST, ENTITY_CHECKED_FUNCTION_CALL, true);

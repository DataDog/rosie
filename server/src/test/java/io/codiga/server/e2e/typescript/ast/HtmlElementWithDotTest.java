...
public class HtmlElementWithDotTest extends E2EBase {
    ...
    public void testHtmlElementNoError() throws Exception {
        Response response = executeTest("bla.js", codeWithError, Language.TYPESCRIPT, ruleCode, "no-foo-dor-bar", RuleType.AST_CHECK, EntityChecked.HTML_ELEMENT, null, true);

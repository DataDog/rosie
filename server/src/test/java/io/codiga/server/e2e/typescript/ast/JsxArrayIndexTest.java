...
public class JsxArrayIndexTest extends E2EBase {
    ...
    public void testArrayKeyError() throws Exception {
        Response response = executeTest("bla.ts", codeWithError, Language.TYPESCRIPT, ruleCode, "index-as-key", RuleType.AST_CHECK, EntityChecked.HTML_ELEMENT, null, true);
